...
class Post(models.Model):
   ...
   def amount_comments(self):
     ...
     #A la hora de guardar un post debemos generar un slug, eso lo definimos en un metodo 
      #actualizar el modelo post para que al guardar un post, se cree una imagen por defecto
...
class Comment(models.Model):
  ...
  #crear un modelo de imagen para los posts, cada posts podra tener una imagen destacada, con nombre
  #mas un campo "active" para activar la imagen y un campo default para definir si es la Imagen esta por defecto
...
def get_image_filename(instance, filename):
   ...
   return os.path.jpin("post/cover/", new_filename)
